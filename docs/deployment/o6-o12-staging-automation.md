...
2. Prepare and independently review AWS trust, registry and control-plane change
   ...
   workflow `951cdf827db06660cd3889cab98cd9154e51a258`. Keep `EnableS3GatewayEndpoint=false`.
...
6. Install the reviewed control-plane files pinned to
   `04255ddc90a3c820bed71588d49752aa9bf4a9f2` through the approved reconciler path. Reconcile/materialize
...
- The immutable identity chain is explicit: builder workflow `114a2613e8090f034925a1bcf148f055653c3a06`,
  executable control-plane code `04255ddc90a3c820bed71588d49752aa9bf4a9f2`, and privileged reusable workflow
  `951cdf827db06660cd3889cab98cd9154e51a258`. The latter checks out the former by exact SHA and asserts HEAD before
