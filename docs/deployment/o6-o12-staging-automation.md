...
2. Prepare and independently review AWS trust, registry and control-plane change
   ...
   workflow `ec9a71e7302a4fd7f5b60475f0951c157465f3d8`. Keep `EnableS3GatewayEndpoint=false`.
...
6. Install the reviewed control-plane files pinned to
   `c41b17cdabb48f3405ebd8a612477fde76bc5818` through the approved reconciler path. Reconcile/materialize
...
- The immutable identity chain is explicit: builder workflow `114a2613e8090f034925a1bcf148f055653c3a06`,
  executable control-plane code `c41b17cdabb48f3405ebd8a612477fde76bc5818`, and privileged reusable workflow
  `ec9a71e7302a4fd7f5b60475f0951c157465f3d8`. The latter checks out the former by exact SHA and asserts HEAD before
