...
2. Prepare and independently review AWS trust, registry and control-plane change
   ...
   workflow `b5000a7167f12a555ca351c78af1079cabe4486c`. Keep `EnableS3GatewayEndpoint=false`.
...
- The immutable identity chain is explicit: builder workflow `114a2613e8090f034925a1bcf148f055653c3a06`,
  ...
  `b5000a7167f12a555ca351c78af1079cabe4486c`. The latter checks out the former by exact SHA and asserts HEAD before
