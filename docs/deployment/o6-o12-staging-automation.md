...
2. Prepare and independently review AWS trust, registry and control-plane change
   ...
   workflow `f25b094611c01f45d3876425a86fb6fdd9b00d91`. Keep `EnableS3GatewayEndpoint=false`.
...
- The immutable identity chain is explicit: builder workflow `114a2613e8090f034925a1bcf148f055653c3a06`,
  ...
  `f25b094611c01f45d3876425a86fb6fdd9b00d91`. The latter checks out the former by exact SHA and asserts HEAD before
