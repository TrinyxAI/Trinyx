...
2. Prepare and independently review AWS trust, registry and control-plane change
   ...
   workflow `f5fc438d9d0ce785e5a6716e41be199bc97591e0`. Keep `EnableS3GatewayEndpoint=false`.
...
- The immutable identity chain is explicit: builder workflow `114a2613e8090f034925a1bcf148f055653c3a06`,
  ...
  `f5fc438d9d0ce785e5a6716e41be199bc97591e0`. The latter checks out the former by exact SHA and asserts HEAD before
