    ...
    <div className="space-y-8">
      <div className="rounded-xl border border-theme p-6">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <a href="https://github.com/TrinyxAI/Trinyx" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-theme-secondary rounded-full flex items-center justify-center hover:bg-theme-tertiary transition-colors">
