    ...
    <div className="space-y-8">
      <div className="rounded-xl border border-theme p-6">
        ...
        <div className="flex items-center justify-center gap-3">
          <a href="https://www.linkedin.com/in/trinyx-ai-5bb4a5430/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-theme-secondary rounded-full flex items-center justify-center hover:bg-theme-tertiary transition-colors">
          ...
          <a href="https://x.com/Trinyxai" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-theme-secondary rounded-full flex items-center justify-center hover:bg-theme-tertiary transition-colors">
          ...
          <a href="https://www.instagram.com/trinyx.ai/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-theme-secondary rounded-full flex items-center justify-center hover:bg-theme-tertiary transition-colors">
          ...
          <a href="https://github.com/eddinerabii/Trinyx" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-theme-secondary rounded-full flex items-center justify-center hover:bg-theme-tertiary transition-colors">
          ...
          <a href="https://www.tiktok.com/@trinyx.ai" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-theme-secondary rounded-full flex items-center justify-center hover:bg-theme-tertiary transition-colors">
          ...
          <a href="https://discord.gg/EykNSkEvM6" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-theme-secondary rounded-full flex items-center justify-center hover:bg-theme-tertiary transition-colors">
