...
/**
 * Name a folder: the create dialog and the rename dialog are the same thing, told apart by
 * whether a current name was handed in. Shared by every list that has folders (skills,
 * workflows, and the other list pages as they are wired), so "create a folder" looks and
...
export function FolderNameDialog({ isOpen, onClose, onCreate, initialName }: FolderNameDialogProps) {
  ...
  const titleId = isRename ? 'rename-folder-dialog-title' : 'create-folder-dialog-title';
