...
![一个 LiveContext 聊天界面：左侧是一句日常语言的请求「每天早上，找出我表里的新注册用户，并给每个人发一条 Slack 欢迎消息」，右侧是画布上生成的工作流：一个早晨触发器，一个查找新注册的步骤，逐个遍历，发送 Slack 消息，并标记为已欢迎。](/blog/chat-to-workflow-no-code-generated.png)
