...
export const deBlog: BlogTranslation = {
  ui: {
    eyebrow: "Notizen aus der Praxis", blogTitle: "Blog", lead: "Praktische Leitfäden zur KI-Automatisierung: was Agenten wirklich kosten, was zu protokollieren ist und wie aus einem Datensatz ein Workflow wird, der sich selbst betreibt.", latest: "Neueste", readThePost: "Beitrag lesen", readMore: "Weiterlesen", allPosts: "Alle Beiträge", minRead: "Min. Lesezeit", by: "Von", and: "und", ctaTitle: "Verwandle deine Nischendaten in eine funktionierende Automatisierung", ctaText: "Beschreibe die Aufgabe im Chat, und Trinyx baut den Workflow vor deinen Augen.", startFree: "Kostenlos starten", metaTitle: "Blog - Trinyx", metaDescription: "Praktische Leitfäden zu KI-Automatisierung und Nischendaten: was KI-Agenten wirklich kosten, was pro Lauf zu protokollieren ist und wie aus einem Datensatz ein Workflow wird, der sich selbst betreibt.",
  },
  posts: {
